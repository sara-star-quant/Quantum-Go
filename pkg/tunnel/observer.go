...
type Observer interface {
	...
	OnEncrypt(ctx context.Context, plaintextLen uint64) (context.Context, func(error))
	OnDecrypt(ctx context.Context, ciphertextLen uint64) (context.Context, func(error))
	OnReplayDetected()
	OnAuthFailure()
