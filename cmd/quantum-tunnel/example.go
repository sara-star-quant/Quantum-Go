...
func main() {
	...
	fmt.Println("  1. Terminal 1: quantum-tunnel demo --mode server --addr :8443")
	fmt.Println("  2. Terminal 2: quantum-tunnel demo --mode client --addr localhost:8443")
	fmt.Println()
	fmt.Println("Run benchmarks:")
	fmt.Println("  quantum-tunnel bench --handshakes 100 --throughput")
	fmt.Println()
